...
import com.kdl.spotifypro.data.remote.MusicDatabase
...
class FirebaseMusicSource  @Inject constructor(
    ...
    fun asMediaSource(dataMediaSourceFactory: DefaultDataSourceFactory): ConcatenatingMediaSource{
        val concatenatingMediaSource = ConcatenatingMediaSource()
        songs.forEach{
            val mediaSource = ProgressiveMediaSource.Factory(dataMediaSourceFactory)
                .createMediaSource(MediaItem.Builder().setUri(it.getString(METADATA_KEY_MEDIA_URI).toUri()).build())
